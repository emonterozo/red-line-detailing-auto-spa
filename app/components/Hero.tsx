...
import { motion } from "framer-motion"; // Added Framer Motion for that "premium" feel
import { MapPin, ShieldCheck, ArrowRight } from "lucide-react"; // Using consistent icons
      ...
      <section className="relative h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-16 md:pt-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            ...
            className="opacity-60 scale-105" // Subtle zoom for depth
            quality={90}
            priority
          />
          {/* Refined Overlays */}
        ...
        <div className="relative z-10 max-w-7xl w-full mx-auto flex items-center">
          <div className="flex-1 space-y-6 lg:space-y-8 pt-10 lg:pt-0">
            ...
            {/* Luxury Badge - Added border pulse */}
            <motion.div 
            ...
            {/* Headline - Added text shadow for legibility */}
            ...
            {/* Subheading - Tighter line height, better color */}
            <p className="text-gray-400 text-sm sm:text-base md:text-lg lg:text-xl max-w-lg lg:max-w-xl leading-relaxed border-l-2 border-[#dc143c]/30 pl-6">
              We specialize in paint-safe detailing using premium techniques. Every vehicle is treated with meticulous care — no shortcuts, no compromise.
            </p>

            {/* CTA Buttons - Refined Hover State */}
            ...
            {/* Location & Service Cards - Enhanced Glassmorphism */}
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              <div className="group flex items-center gap-4 bg-white/[0.02] hover:bg-white/[0.05] backdrop-blur-2xl border border-white/5 rounded-2xl px-6 py-4 transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-white font-bold text-sm truncate">Loma de Gato Marilao Bulacan</p>
                </div>
              </div>
              ...
              <div className="group flex items-center gap-4 bg-white/[0.02] hover:bg-white/[0.05] backdrop-blur-2xl border border-white/5 rounded-2xl px-6 py-4 transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="min-w-0">
                  <p className="text-gray-500 text-[10px] uppercase font-black tracking-widest">Service</p>
                  <p className="text-white font-bold text-sm truncate">On-the-Go Auto Care</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Scroll Indicator - Re-styled for better HUD feel */}
